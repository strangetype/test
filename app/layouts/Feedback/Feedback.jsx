                    ...
                    {[1,2,3,4,5,6,7].map(()=> {
                        return <div className="feedback">
                            ...
                            <div className="feedback-message">
                                ...
                                Мне очень понравилась фотосессия)) сначала я правда чувствовала себя скованно, т.к. это была первая фотосессия в моей жизни)) а потом Настюха исправила ситуацию))) все было очень не официально, классно пообщались, за что спасибо))) от этого и фото просто чудесные получились, потому что я почувствовала нашего любимого фотографа "своим человеком")) короче, умеет найти подход, фото супер, ракурс то что надо, цвета, ретушь...все отлично!))
                            </div>
                        </div>
                    })}
